          ...
          <div className="flex items-center justify-between flex-col lg:flex-row">
            ...
            <div className="xl:w-[670px]">
              <h2 className="heading">
                Get virtualtratment <br /> anytime.
              </h2>
              <ul className="pl-4">
                ...
                <li className="text_para">
                  3. View our physicians who are accepting new paitients, use
                  the online scheduling tool to select an appoinment time.
                </li>
              </ul>
              <Link to="/">
